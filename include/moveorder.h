...
class MoveOrderer {
 public:
  MoveOrderer(const Position& pos, const Move table_move, int ply,
              const KillerHeuristic* kh, const HistoryHeuristic* hh,
 ...
 private:
  ...
  GradedMove *curr, *end_moves, *end_bad_captures, *begin_bad_quiets,
      *end_bad_quiets;
